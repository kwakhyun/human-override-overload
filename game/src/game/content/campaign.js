...
export const BASE_NPCS = deepFreeze({
  ...
  lark: {
    ...
    portraitDialogue: [
      ...
      "비행 계획은 준비됐어. 전술 효과를 확인하면 다음 출격부터 바로 적용할 수 있어.",
      "하늘길은 내가 열게. 지휘관은 지상 전투와 귀환 신호만 놓치지 마.",
    ],
    interaction: "open-flight-operations",
    flightOperationLabel: "항공 지원 전술",
    flightOperationsDialogue: [
      "나이트자 지원 전술을 준비했어. 출격 전에 한 가지를 선택하면 전투 내내 효과가 유지돼.",
      "정찰, 보급, 요격 엄호 중 지금 작전에 필요한 지원을 골라. 적용은 내가 확인할게.",
    ],
    interactionLabel: "항공 지원 전술",
    dialogue: [
      "나이트자 출격 준비 완료. 전술 지원을 선택하면 비행 계획에 바로 반영할게.",
      "귀환 항로까지 확보했어. 출격 전에 필요한 지원 효과만 확인해 줘.",
    ],
    milestoneDialogue: [
      "이지스, 앞선 세 구역에서 같은 좌표 파편이 나왔어. NIGHTJAR가 외곽 권역으로 가는 항로를 찾아냈어.",
      "네온 주조구, 폭풍 첨탑, 생체 금고. 지금까지 본 원형 추론핵과는 다른 지휘 개체와 중간 방어체가 기다리고 있어.",
      "외곽 권역은 이미 지도에 열려 있어. 권역을 고른 다음, 그 안에서 출격할 구역을 선택하면 돼.",
    ],
  },
  rhea: {
    id: "rhea",
