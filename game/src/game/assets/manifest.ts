...
export const REGION_ROUTE_ASSETS: Readonly<Record<RegionId, readonly AssetDefinition[]>> = Object.freeze({
  "wrong-engine-core": freezeAssets([
    ...
    { key: ASSET_KEYS.sector4Expanded, path: "./assets/overload/environment/sector-04-reactor-vault-expanded.webp", performancePath: "./assets/overload/environment/performance/sector-04-reactor-vault-expanded.webp", kind: "image" },
  ...
  "glass-dune": freezeAssets([
    ...
    { key: ASSET_KEYS.glassDuneRouteExpanded, path: "./assets/overload/regions/glass-dune/route-expanded-v2.webp", performancePath: "./assets/overload/regions/glass-dune/performance/route-expanded-v2.webp", kind: "image" },
  ]),
  "abyssal-archive": freezeAssets([
    ...
    { key: ASSET_KEYS.abyssalArchiveRouteExpanded, path: "./assets/overload/regions/abyssal-archive/route-expanded-v2.webp", performancePath: "./assets/overload/regions/abyssal-archive/performance/route-expanded-v2.webp", kind: "image" },
  ]),
  "neon-foundry": freezeAssets([
    ...
    { key: ASSET_KEYS.neonFoundryRouteExpanded, path: "./assets/overload/regions/neon-foundry/route-expanded-v2.webp", performancePath: "./assets/overload/regions/neon-foundry/performance/route-expanded-v2.webp", kind: "image" },
  ...
  "storm-spire": freezeAssets([
    ...
    { key: ASSET_KEYS.stormSpireRouteExpanded, path: "./assets/overload/regions/storm-spire/route-expanded-v2.webp", performancePath: "./assets/overload/regions/storm-spire/performance/route-expanded-v2.webp", kind: "image" },
  ...
  "gene-vault": freezeAssets([
    ...
    { key: ASSET_KEYS.geneVaultRouteExpanded, path: "./assets/overload/regions/gene-vault/route-expanded-v2.webp", performancePath: "./assets/overload/regions/gene-vault/performance/route-expanded-v2.webp", kind: "image" },
