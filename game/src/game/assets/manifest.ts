...
export const DOM_PREVIEW_ASSET_PATHS = Object.freeze({
  ...
  vesperPortrait: "./assets/overload/hero/vesper-portrait-v3.png",
  ...
  ilyaPortrait: "./assets/overload/ui/npcs/ilya-mechanic-v2.png",
  nightjarPilot: "./assets/overload/ui/npcs/sera-nightjar-pilot-v2.png",
