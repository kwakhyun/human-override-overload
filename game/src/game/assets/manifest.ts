...
export const DOM_PREVIEW_ASSET_PATHS = Object.freeze({
  ...
  player: "./assets/overload/hero/survivor-portrait-v2.webp",
  portrait: "./assets/overload/hero/survivor-portrait-v2.webp",
  mikaPortrait: "./assets/overload/hero/mika-portrait-v2.webp",
  vesperPortrait: "./assets/overload/hero/vesper-portrait-v7.webp",
  noxPortrait: "./assets/overload/hero/nox-portrait-v1.webp",
  ...
  hanaPortrait: "./assets/overload/ui/npcs/hana-research-director-v2.webp",
  ilyaPortrait: "./assets/overload/ui/npcs/ilya-mechanic-v4.webp",
  nightjarPilot: "./assets/overload/ui/npcs/sera-nightjar-pilot-v4.webp",
  rheaControlOfficer: "./assets/overload/ui/npcs/rhea-control-officer-v3.webp",
