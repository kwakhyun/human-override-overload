...
export function resolveMusicTrack(screen, regionId) {
  ...
  if (["base", "defense-select", "defense-result"].includes(screen)) return BASE_BGM_PATH;
...
export function musicTrackLabel(screen, regionId) {
  ...
  if (["base", "defense-select", "defense-result"].includes(screen)) return "LAST LIGHT IN HAVEN-09";
