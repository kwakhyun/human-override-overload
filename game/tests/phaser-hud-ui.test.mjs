...
test("Escape pause is guarded from modal states and supports resume, local restart, and unlocked base exit", async () => {
  ...
  assert.match(app, /\[assets, characterId, characterSkillRanksSignature, combatBonusesSignature, mainWeaponId, mikaUnlocked, noxUnlocked, regionId, runRevision, sfx, vesperUnlocked\]/);
