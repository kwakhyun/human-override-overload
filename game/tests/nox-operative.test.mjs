...
test("NOX ships dedicated portrait, sprite, skill VFX, recruitment, and HUD integration", async () => {
  ...
  assert.match(manifest, /path: "\.\/assets\/overload\/hero\/nox-directional-aim-atlas\.png"/);
  assert.match(manifest, /path: "\.\/assets\/overload\/vfx\/manual\/nox-ability-hd-atlas\.png"/);
