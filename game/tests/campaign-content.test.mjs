...
test("the base has HANA, ILYA, SERA, and RHEA with authored portraits and interactions", () => {
  ...
  assert.equal(BASE_NPCS.hana.portraitPath, "./assets/overload/ui/npcs/hana-research-director-v2.webp");
  ...
  assert.equal(BASE_NPCS.ilya.portraitPath, "./assets/overload/ui/npcs/ilya-mechanic-v4.webp");
  ...
  assert.equal(BASE_NPCS.rhea.portraitPath, "./assets/overload/ui/npcs/rhea-control-officer-v3.webp");
