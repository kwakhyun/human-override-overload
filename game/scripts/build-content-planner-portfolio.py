...
ASSETS = {
    ...
    "boss": ROOT / "docs/project/media/content-planner" / "latest-boss-pattern-prism-lattice-desktop-1440x810.png",
    "reward": ROOT / "docs/project/media/content-planner" / "latest-reward-neutral-focus-desktop-1440x810.png",
    "aegis": ROOT / "docs/project/media/content-planner" / "character-information-desktop.png",
    "mika": ROOT / "docs/project/media/content-planner" / "character-information-mika.png",
    "research": ROOT / "docs/project/media/content-planner" / "haven-research-facility-1569x912.png",
    "mobile_world": ROOT / "docs/project/media/content-planner" / "mobile-portrait-world-map-390x844.png",
    "mobile_combat": ROOT / "docs/project/media/content-planner" / "mobile-portrait-combat-390x844.png",
    "defense": ROOT / "docs/project/media/content-planner" / "defense-mode-smoke.png",
    ...
    "siege_atlas": ROOT / "docs/project/media/content-planner/siege-walker-motion-atlas.png",
}
