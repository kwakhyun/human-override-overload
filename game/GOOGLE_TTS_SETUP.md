...
과거 Q/E 파일과 생성 항목은 정리했으며, 과거 대사·해시는 아래 기록과 Git 이력으로 확인합니다. 인증 정보는
브라우저 번들이나 저장소에 들어가지 않습니다.

## 제작된 대사와 런타임 상태

- Q / EMP PULSE: `EMP 전개.` · 파일 제거, 제작 이력만 보존
- E / AEGIS WARD: `방벽 전개.` · 파일 제거, 제작 이력만 보존
...
- 출력: 현재 MP3 2개, 런타임 등록 MP3 2개, `public/assets/audio/agent/`
...
| 키 | 상태 | 파일 | 크기 | SHA-256 |
| --- | --- | --- | ---: | --- |
| Q | Git 이력 | `emp-pulse-start.mp3` | 4,800 bytes | `f17caa8477a6e53672b328f265e958b933859778913a9420bf4d44151256fddc` |
| E | Git 이력 | `aegis-ward-start.mp3` | 3,072 bytes | `9eeda8a260be74f9c451cc0df506c16766f1e16c4a2d0b14db9c0c4151bb49b8` |
